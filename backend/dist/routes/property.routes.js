...
router.delete("/:id", protected_1.authenticate, protected_1.isAgent, asyncHandler(property_controller_1.deleteProperty));
router.put("/:id", protected_1.authenticate, protected_1.isAgent, asyncHandler(property_controller_1.updateProperty));
router.get("/agent/:agentId", protected_1.authenticate, protected_1.isAgent, asyncHandler(property_controller_1.getAgentProperties));
router.get("/suggested", asyncHandler(property_controller_1.getSuggestedProperties));
router.patch("/status/:id", protected_1.authenticate, protected_1.isAgent, asyncHandler(property_controller_1.updatePropertyStatus));
